...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* ── Header ── */}
      <header className="sticky top-0 z-20 bg-background/80 backdrop-blur-sm py-2 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto bg-card border border-border rounded-xl px-4 sm:px-6 h-14 flex items-center gap-2 sm:gap-4 shadow-sm">
          {/* Logo */}
